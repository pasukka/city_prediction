...
### Астана vs Алма-Аты
Столица Казахстана называется Алматы, однако иногда по-прежнему используется название Алма-Ата, что не совсем верно.
В результатах второй модели можно заметить использование второго варианта.
